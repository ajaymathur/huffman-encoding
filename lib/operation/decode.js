...
const { ensureFileExits, readFile, writeFile } = require("../utils/fs");

async function decode(pathToFile, cwd) {
  ...
  await writeFile(path.join(cwd, "decoded.txt"), decodedText.join(""), "utf8");
}
